    ...
    async _request(params, options = {}, otelSpan) {
        ...
        while (meta.attempts <= maxRetries) {
            try {
                ...
                let timeout = (_18 = (_17 = options.requestTimeout) !== null && _17 !== void 0 ? _17 : this[symbols_1.kRequestTimeout]) !== null && _18 !== void 0 ? _18 : undefined;
                if (timeout != null)
                ...
                const contentEncoding = ((_19 = headers['content-encoding']) !== null && _19 !== void 0 ? _19 : '').toLowerCase();
                if (contentEncoding.includes('gzip') || contentEncoding.includes('deflate')) {
                    body = await unzip(body);
                }
                if (Buffer.isBuffer(body) && !(0, BaseConnection_1.isBinary)((_20 = headers['content-type']) !== null && _20 !== void 0 ? _20 : '')) {
                    body = body.toString();
                }
                ...
                if (headers['content-type'] !== undefined &&
                    (((_21 = headers['content-type']) === null || _21 === void 0 ? void 0 : _21.includes('application/json')) ||
                        ((_22 = headers['content-type']) === null || _22 === void 0 ? void 0 : _22.includes('application/vnd.elasticsearch+json'))) &&
